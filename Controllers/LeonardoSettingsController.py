...
class LeonardoSettingsController:
    ...
    def updateLists( self ):
        ...
        language = self.leonardoSettingsModel.getKeyByValue( self.leonardo['language_list'], self.leonardo['language'] )
        self.leonardoSettingsView.setLanguage( language )
        variant = self.leonardoSettingsModel.getKeyByValue( self.leonardo['variant_list'], self.leonardo['variant'] )
        self.leonardoSettingsView.setVariant( variant )
        owner = self.leonardoSettingsModel.getKeyByValue( self.leonardo['owner_list'], self.leonardo['owner'] )
        self.leonardoSettingsView.setOwner( owner )
        aspect_ratio = self.leonardoSettingsModel.getKeyByValue( self.leonardo['aspect_ratio_list'], self.leonardo['aspect_ratio'] )
        self.leonardoSettingsView.setAspectRatio( aspect_ratio )
        copyright = self.leonardoSettingsModel.getKeyByValue( self.leonardo['copyright_list'], self.leonardo['copyright'] )
